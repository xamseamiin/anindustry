  ...
  return (
    <main className="min-h-screen bg-slate-950 px-5 py-12 text-white">
      <div className="mx-auto max-w-md rounded-3xl border border-cyan-400/25 bg-slate-900 p-7 text-center shadow-2xl">
        ...
        <a href={`${APK_PATH}?release=20260921-2`} target="_blank" rel="noopener noreferrer external" className="mt-7 block w-full rounded-2xl bg-emerald-400 px-5 py-4 text-sm font-black text-slate-950 transition hover:bg-emerald-300">Download Android App</a>
